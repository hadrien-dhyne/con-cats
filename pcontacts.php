...
<form method="POST" action="admin/admin-contacts.php">  
    ...
    <div class="mb-3">
        ...
        <input autofocus type="text" class="form-control" id="cfirstname" name="firstnamec">
    </div>

    <div class="mb-3">
        <label for="lastnamec" class="form-label">Last name</label>
        <input type="text" class="form-control" id="clastname" name="lastnamec">
    </div>

    <div class="mb-3">
        <label for="phone" class="form-label">Phone number</label>
        <input type="text" class="form-control" id="cphone-number" name="phone" maxlength="12" minlength="12" value="+32"> 
